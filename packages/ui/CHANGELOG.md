...
- b25d3d4: DatePicker: hug the calendar to its dates, and close the gap in a selected range
...
- Updated dependencies [b25d3d4]
  - @gigradar/theme@2.1.1

## 2.1.2

### Patch Changes

- 94a87e6: Stop the advanced search panel being squeezed by the column it hangs from.
